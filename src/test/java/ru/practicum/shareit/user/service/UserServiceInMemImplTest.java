...
class UserServiceInMemImplTest {
    @Mock
    private InMemoryUserStorage inMemoryUserStorage;
    @InjectMocks
    private UserServiceInMemImpl userServiceInMemImpl;
    private User user;
    ...
    void getAllUsers() {
        ...
        List<User> returnedList = userServiceInMemImpl.getAllUsers();
    ...
    void getUser_whenUserFound_thenReturnUser() {
        ...
        User returnedUser = userServiceInMemImpl.getUser(userId);
    ...
    void addUser() {
        ...
        UserDto returnedUser = userServiceInMemImpl.addUser(userDto);
    ...
    void updateUser_whenUserNotFound_thenThrowNewNotFoundException() {
        ...
        assertThrows(NotFoundException.class, () -> userServiceInMemImpl.getUser(userId));
    ...
    void updateUser_whenUserFound_thenReturnUser() {
        ...
        userServiceInMemImpl.updateUser(userId, userDto);
    ...
    void deleteUser_whenUserNotFound_thenThrowException() {
        ...
        assertThrows(NotFoundException.class, () -> userServiceInMemImpl.deleteUser(userId));
