...
class ItemServiceInMemImplTest {
    @Mock
    private InMemoryItemStorage inMemoryItemStorage;
    @Mock
    private InMemoryUserStorage inMemoryUserStorage;
    @InjectMocks
    private ItemServiceInMemImpl itemServiceInMemImpl;
    ...
    void addItem_whenOwnerFound_thenReturnItem() {
        ...
        ItemWithRequestDto returnedItemWithRequestDto = itemServiceInMemImpl.addItem(owner.getId(), itemWithRequestDto);
    ...
    void updateItem_whenUserNotFound_thenThrowNewNotFoundException() {
        ...
        assertThrows(NotFoundException.class, () -> itemServiceInMemImpl.updateItem(ownerId, itemDto, itemDto.getId()));
    ...
    void updateItem_whenItemFound_thenReturnItem() {
        ...
        itemServiceInMemImpl.updateItem(ownerId, itemDtoForUpdate, itemDto.getId());
    ...
    void getItem() {
        ...
        ItemWithBookingDto returnedItemWithBookingDto = itemServiceInMemImpl.getItem(owner.getId(), item.getId());
    ...
    void getItems() {
        ...
        List<ItemWithBookingDto> returnedList = itemServiceInMemImpl.getItems(owner.getId(), 0, 1);
    ...
    void getItemsBySearch_whenTextIsEmpty_thenReturnEmptyList() {
        ...
        List<ItemDto> returnedList = itemServiceInMemImpl.getItemsBySearch("", 0, 1);
    ...
    void getItemsBySearch_whenTextIsNotEmpty_thenReturnListWithOneItem() {
        ...
        List<ItemDto> returnedList = itemServiceInMemImpl.getItemsBySearch("item", 0, 1);
