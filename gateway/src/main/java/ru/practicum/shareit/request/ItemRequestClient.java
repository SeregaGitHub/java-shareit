...
public class ItemRequestClient extends BaseClient {
    ...
    public ResponseEntity<Object> getItemRequestsList(Integer userId) {
        return get("", userId);
    }

    public ResponseEntity<Object> getItemRequestById(Integer userId, Integer requestId) {
        return get("/" + requestId, Long.valueOf(userId));
    }

    public ResponseEntity<Object> getAllItemRequestsList(Integer userId, Integer from, Integer size) {
