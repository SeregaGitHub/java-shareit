...
class ItemServiceImplTest {
    ...
    void getItems_whenPageRequestIs01_thenReturnList() {
        Integer userId = user.getId();
        when(itemRepository.findItemsShotByOwner_IdOrderById(userId, PageRequest.of(0, 1)))
        ...
        verify(itemRepository, times(1)).findItemsShotByOwner_IdOrderById(userId, PageRequest.of(0, 1));
    }

    @Test
    void getItems_whenThereIsNoPageRequest_thenReturnList() {
        Integer userId = user.getId();
        when(itemRepository.findItemsShotByOwner_IdOrderById(userId))
                .thenReturn(List.of(new ItemShot() {
                    @Override
                    public Integer getId() {
                        return 0;
        ...
        assertEquals(1, returnedList.size());
        verify(itemRepository, times(1)).findItemsShotByOwner_IdOrderById(userId);
    }
